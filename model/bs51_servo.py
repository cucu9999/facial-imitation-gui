...
def manual_model(bs_dict, rpy_angles):
    ...
    head_bai =   map_range(rpy_angles[2], -45, 45, 0, 1)
    ...
    mouthCornerUpLeft    = map_range(bs_dict['MouthSmileLeft'], 0, 1, 0, 1)
    mouthCornerUpRight   = map_range(bs_dict['MouthSmileRight'], 0, 1, 0, 1)
    ...
    mouthCornerDownLeft  =   map_range(4*bs_dict['MouthFrownLeft'], 0, 1, 0.5, 1)
    mouthCornerDownRight =   map_range(4*bs_dict['MouthFrownRight'], 0, 1, 0.5, 1)
